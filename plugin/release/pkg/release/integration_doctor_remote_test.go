...
func (inspector integrationDoctorRecordingRemoteInspector) Inspect(
	...
	*inspector.calls++
	_, _ = inspector.tokens.ResolveGitHubActionsDispatchToken(ctx)
...
func (resolver integrationDoctorRecordingTokenResolver) ResolveGitHubActionsDispatchToken(
	_ context.Context,
) (GitHubActionsDispatchToken, error) {
	...
	return NewGitHubActionsDispatchToken(resolver.value)
}
