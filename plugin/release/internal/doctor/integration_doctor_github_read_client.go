...
type integrationDoctorGitHubReader interface {
	Repository(context.Context, integrationDoctorRepositoryIdentity, githubReadToken) (integrationDoctorGitHubRepository, integrationDoctorGitHubReadOutcome)
	WorkflowContent(context.Context, integrationDoctorRepositoryIdentity, string, string, githubReadToken) (integrationDoctorGitHubWorkflowContent, integrationDoctorGitHubReadOutcome)
	WorkflowMetadata(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubWorkflowMetadata, integrationDoctorGitHubReadOutcome)
	RepositoryVariable(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubVariable, integrationDoctorGitHubReadOutcome)
	RepositorySecret(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubSecretMetadata, integrationDoctorGitHubReadOutcome)
	ActionsPolicy(context.Context, integrationDoctorRepositoryIdentity, githubReadToken) (integrationDoctorGitHubActionsPolicy, integrationDoctorGitHubReadOutcome)
	ReleaseByTag(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubRelease, integrationDoctorGitHubReadOutcome)
	TagReference(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubTagReference, integrationDoctorGitHubReadOutcome)
	WorkflowRun(context.Context, integrationDoctorRepositoryIdentity, string, githubReadToken) (integrationDoctorGitHubWorkflowRun, integrationDoctorGitHubReadOutcome)
}
